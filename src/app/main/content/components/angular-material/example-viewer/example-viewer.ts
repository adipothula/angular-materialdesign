...
import { jasAngAnimations } from 'JasAng/animations';
...
@Component({
    selector: 'jasAng-example-viewer',
    templateUrl: './example-viewer.html',
    styleUrls: ['./example-viewer.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: jasAngAnimations
})
export class JasAngExampleViewerComponent implements AfterViewInit, OnDestroy {
    ...
    constructor(
        ...
        private copier: JasAngCopierService,
