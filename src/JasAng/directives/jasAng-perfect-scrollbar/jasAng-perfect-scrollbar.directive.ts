...
@Directive({
    selector: '[jasAngPerfectScrollbar]'
})
export class JasAngPerfectScrollbarDirective implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit() {
        this.onConfigChanged =
            this.jasAngConfig.onConfigChanged.subscribe(
                (settings) => {
