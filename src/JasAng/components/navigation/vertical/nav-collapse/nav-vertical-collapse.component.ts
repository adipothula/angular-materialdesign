...
import { JasAngNavigationService } from '../../navigation.service';
import { NavigationEnd, Router } from '@angular/router';
import { jasAngAnimations } from '../../../../animations/index';

@Component({
    selector   : 'jasAng-nav-vertical-collapse',
...
export class JasAngNavVerticalCollapseComponent implements OnInit
{
    @Input() item: any;
