...
@Component({
    selector     : 'jasAng-widget',
    templateUrl  : './widget.component.html',
    styleUrls    : ['./widget.component.scss'],
    encapsulation: ViewEncapsulation.None
})

export class JasAngWidgetComponent implements AfterContentInit
{
    @HostBinding('class.flipped') flipped = false;
    @ContentChildren(JasAngWidgetToggleDirective, {descendants: true}) toggleButtons: QueryList<JasAngWidgetToggleDirective>;
