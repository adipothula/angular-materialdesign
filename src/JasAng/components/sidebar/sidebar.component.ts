...
import { JasAngSidebarService } from './sidebar.service';
...
@Component({
    selector     : 'jasAng-sidebar',
    templateUrl  : './sidebar.component.html',
    styleUrls    : ['./sidebar.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class JasAngSidebarComponent implements OnInit, OnDestroy
{
    // Name
    @Input()
    name: string;
     ...
     * @param {JasAngConfigService} jasAngConfigService
     * @param {JasAngSidebarService} jasAngSidebarService
     * @param {JasAngMatchMediaService} jasAngMatchMediaService
     */
    constructor(
        ...
        private jasAngConfigService: JasAngConfigService,
        private jasAngSidebarService: JasAngSidebarService,
        private jasAngMatchMediaService: JasAngMatchMediaService
    )
    {
        // Set the defaults
        this.opened = false;
    ...
    ngOnInit(): void
    {
        ...
        this.jasAngSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void
    {
        ...
        this.jasAngSidebarService.unregister(this.name);
    ...
    private _setupLockedOpen(): void
    {
        ...
        this._onMediaChangeSubscription =
            ...
            this.jasAngMatchMediaService.onMediaChange.subscribe(() => {
                ...
                if ( isActive )
                {
                    ...
                    if ( this.jasAngConfigService.config.layout.navigationFolded )
                    {
                        this.fold();
                    }
    ...
    showBackdrop(): void
    {
        ...
        this._backdrop.classList.add('jasAng-sidebar-overlay');
